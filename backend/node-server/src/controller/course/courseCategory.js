...
const createCourseCategory = async (req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      message: 'Error Occured while creating courseCategory',
      error: error,
    });
  }
};
const updateCourseCategory = async (req, res) => {
  ...
  try {
    ...
    return res.status(400).json({
      message: 'Error Occured while updating courseDomain',
      error: error,
    });
  }
};
...
const deleteCourseCategory = async (req, res) => {
  ...
  try {
    ...
    return res.status(204).json({
      message: 'Error Occured while deleting courseCategory',
      error: e,
    });
  }
};
