...
const getAllCourseDomain = async (req, res) => {
  const courseDomains = await prisma.courseDomain.findMany();
  res.status(200).json(courseDomains);
};
...
const getCourseDomain = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(202)
      .json({ message: 'found courseDomain', courseDomain });
  } catch (error) {
...
const createCourseDomain = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({
        message: 'Error Occured while creating courseDomain',
        error: error,
      });
  }
};
...
const updateCourseDomain = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(400)
      .json({ message: 'Error Occured while updating courseDomain' });
  }
};
...
const deleteCourseDomain = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(204)
      .json({ message: 'Error Occured while deleting courseDomain', error: e });
  }
};
